...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.zh.List": "../../app/util.js",
  "Ext.zh.plugin.ListPaging": "../../app/util.js",
  "Ext.zh.plugin.PullRefresh": "../../app/util.js",
  "UX": "../../app/ux",
  "UX.TouchCalendarViewModel": "../../app/ux/TouchCalendarView.js",
  "ux.picker.DateTime": "../../app/ux/picker/DateTime.js"
});

Ext.ClassManager.addNameAlternateMappings({
  "EQMS.controller.Apps": [],
  "EQMS.controller.Home": [],
  "EQMS.controller.HostMgr": [],
  "EQMS.controller.Login": [],
  "EQMS.controller.Mine": [],
  "EQMS.controller.lpa.ItemDetail": [],
  "EQMS.controller.lpa.ItemList": [],
  "EQMS.controller.lpa.LpaList": [],
  "EQMS.controller.warn.ListDetail": [],
  "EQMS.controller.warn.Station": [],
  "EQMS.controller.warn.Warn": [],
  "EQMS.controller.warn.WarnList": [],
  "EQMS.controller.xj.ItemDetail": [],
  "EQMS.controller.xj.ItemList": [],
  "EQMS.controller.xj.List": [],
  "EQMS.model.Calendar": [],
  "EQMS.model.Host": [],
  "EQMS.model.User": [],
  "EQMS.model.lpa.ItemDetail": [],
  "EQMS.model.lpa.ItemList": [],
  "EQMS.model.lpa.LpaList": [],
  "EQMS.model.lpa.Part": [],
  "EQMS.model.lpa.ResDepartment": [],
  "EQMS.model.lpa.Station": [],
  "EQMS.model.warn.Equipment": [],
  "EQMS.model.warn.Line": [],
  "EQMS.model.warn.ListDetail": [],
  "EQMS.model.warn.ProblemType": [],
  "EQMS.model.warn.Solution": [],
  "EQMS.model.warn.Station": [],
  "EQMS.model.warn.Warn": [],
  "EQMS.model.warn.WarnList": [],
  "EQMS.model.xj.ItemDetail": [],
  "EQMS.model.xj.ItemList": [],
  "EQMS.model.xj.List": [],
  "EQMS.store.Abstract.Store": [],
  "EQMS.store.Hosts": [],
  "EQMS.store.lpa.ItemList": [],
  "EQMS.store.lpa.LpaList": [],
  "EQMS.store.lpa.Part": [],
  "EQMS.store.lpa.ResDepartment": [],
  "EQMS.store.lpa.Station": [],
  "EQMS.store.warn.Equipment": [],
  "EQMS.store.warn.Line": [],
  "EQMS.store.warn.ProblemType": [],
  "EQMS.store.warn.Solution": [],
  "EQMS.store.warn.Station": [],
  "EQMS.store.warn.Warn": [],
  "EQMS.store.warn.WarnList": [],
  "EQMS.store.xj.ItemList": [],
  "EQMS.store.xj.List": [],
  "EQMS.util": [
    "util"
  ],
  ...
  "EQMS.view.lpa.LpaList": [
    "lpaList"
  ],
  "EQMS.view.warn.ListDetail": [],
  "EQMS.view.warn.Station": [],
  "EQMS.view.warn.Warn": [],
  "EQMS.view.warn.WarnList": [],
  "EQMS.view.xj.ItemDetail": [],
  "EQMS.view.xj.ItemList": [],
  "EQMS.view.xj.List": [],
  ...
  "UX.TouchCalendarViewModel": [],
  "UX.field.DateTimePicker": [],
  "UX.field.DisplayComponent": [],
